...
//0x42
void r_tau0_channel4_interrupt(void) __attribute__ ((interrupt));
//0x44
void r_tau0_channel5_interrupt(void) __attribute__ ((interrupt));
//0x48
void r_tau0_channel7_interrupt(void) __attribute__ ((interrupt));
//Hardware Vectors
//0x0
