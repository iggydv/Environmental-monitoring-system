...
int powerCount=0, wind_count1 = 0, wind_count2 = 0, buzTime = 0, buzTimeFlag = 0, twoFlag = 0, oneFlag = 0, tenMilFlag = 0, valuesTimer = 0, fiveMilFlag = 0;
/* End user code. Do not edit comment generated here */
...
void r_tau0_channel3_interrupt(void)
{
	...
	oneFlag = 1;
	//valuesTimer = 0;
	if(((cycleTimer%2)==0)&&(cycleTimer!=0))
	{
		twoFlag=1;
	}
